...
gender = idx |>
  ...
  harmonize_gender()
```
uiteindelijk de genders koppelen aan names (input bestand) en dan opslaan als gender. dit bestand heeft dus 2739 unieke regels waaraan een gender gekoppeld is. 
kijk even welke codering je dominant maakt. wmb gender1_meertens, gender2_genderizeR en gender is de combi. 

```{r}
fsaveRDS(gender, "gender")
```

zorg dat je alleen op de unique de scrape uitvoert en ...check of de naam als gescraped is. 
