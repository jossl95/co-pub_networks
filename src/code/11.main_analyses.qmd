...
istat <- varCovar(colnet[['data']]$soc)
...
myeff <- includeEffects(myeff, density, recip, inPopSqrt, outActSqrt,gwespFF,transTies, name='first')
...
myeff <- includeInteraction(myeff, transTies, altX, interaction1=c("", "gender"))
