...
includeDefaultEffects <- function(myeff){
  myeff <- includeEffects(myeff, density, recip, gwespFF)
  ...
  #   # myeff <- includeEffects(myeff, simX, interaction1 = glue("uni${name}"))
  #   # sameX and simX result in collinearity between outdegree and uva-similarity
  # }
...
# myeff <- getEffects(mydata)
# myeff <- includeDefaultEffects(myeff)
myeff <- includeEffects(myeff, egoX, interaction1 = 'intdis')
