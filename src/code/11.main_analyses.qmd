...
uni_levels = tolower(c("RU", "UU", "UVA"))
...
# myeff <- includeEffects(myeff, density, recip)
myeff <- includeEffects(myeff, isolatePop, inIsDegree)
...
```{r}
# myeff <- includeInteraction(myeff, egoX, egoX, interaction1=c("gender", 'funcs[[1]]'))
# myeff <- includeInteraction(myeff, egoX, egoX, interaction1=c("gender", 'funcs[[2]]'))
# myeff <- includeInteraction(myeff, egoX, egoX, interaction1=c("gender", 'funcs[[3]]'))
# myeff <- includeInteraction(myeff, egoX, egoX, interaction1=c("gender", 'funcs[[4]]'))
