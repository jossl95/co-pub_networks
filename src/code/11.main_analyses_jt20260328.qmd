...
<!-- we should construct same uni ourselves and based on the two affiliations --> 

<!-- for distances, you take the first affiliation of the scholar I presume 
I do not know exactly what RSiena does internally but for scholars not affiliated to the university of the selection, distances should be set to NA I guess. Thus we play with selection on RU scholars. Some work at different unis and get a distance.--> 
...
mydata <- sienaDataCreate(
  first, last, 
  gender, soc, mig$M4, mig$other,
  # uni$ru, uni$ul, uni$uu, uni$uva, uni$uvg, uni$uvt, uni$vu,
  # uni$uu, 
  # uni$uva, uni$uvg,
  funcs[[1]], funcs[[2]], funcs[[3]], funcs[[4]], intdis, 
  dissim, distan
)
```
